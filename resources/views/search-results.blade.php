    ...
    <section class="px-5 mt-5">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-9">
                    <form method="POST" action="{{ url('/register/account') }}" role="form"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-secondary">
                                    <i>
                                        We can obtain permit history for <span class="permit-blue">{{ str_replace('USA', '', $search) }} {{$zip_code}}</span>
                                    </i><br>
                                        ...
                                        <div class="card">
                                            <div class=" card-header permit-bg-grey">
                                                <div class="row">
                                                    ...
                                                    <div class="col-1 p-0">
                                                        <input
                                                            class="form-check-input permit-radio pull-right input contAddress"
                                                            type="radio" name="pricePlan"
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <h3 class="permit-text" style="margin-bottom:8px;">Step 2. Account info</h3>
                                <span class="login-link-wrapper">
                                    Already Have An Account? <a class="btnn coupon-code-link" href="javascript:void(0)" onclick="$(window).scrollTop(0);" oncontextmenu="redirect_home()">
                                    <span class="underline-blue">Log In</span>
                                </span>
                                </a>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="blue-bg-btn">
                                            <button class="btn btnn-effect" style="background: #5AB9E3!important;color:#fff;"
                                                    id="regSubForm" type="submit">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
